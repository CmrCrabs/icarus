//CREDIT: https://github.com/luiscarlospando/crt-shader-with-chromatic-aberration-glow-scanlines-dot-matrix/
//
//-----------------------------------------------------------------------------
...
const float ABBERATION_FACTOR = 0.01;    // Strength of color splitting effect (default: 0.05)
...
// Dot Matrix Settings
const float MASK_INTENSITY = 0.05;          // Strength of the dot pattern (default: 0.3)
