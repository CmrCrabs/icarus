...
- :EDITOR: relevant to editor experience
- :FUTURE: to be updated / changed / implemented later
- :HACK: is temp code
...
(add-to-list 'load-path (expand-file-name "~/.emacs.d/infinite.el"))
#+end_src
** osx-specific fixes
#+begin_src emacs-lisp :tangle ~/.emacs.d/init.el
...
(use-package perspective
  ...
  (setq persp-state-default-file "~/.emacs.d/sessions"
        ...
        persp-initial-frame-name "[1] org"
...
;; DONE modeline
;; TODO centaur tabs interactions
;; TODO auto close scratch buffer
;; TODO saving/loading
...
(evil-define-key '(normal visual insert) 'global (kbd "TAB") 'evil-toggle-fold)
#+end_src
...
(zf/leader
  ...
  "bq" '(quit-window-kill-buffer :which-key "kill current")
